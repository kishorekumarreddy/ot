    ...
    <div class="row">
        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
         ...
         <h2 class="title text-left">
         	Students List
         	<!-- <button class="btn notification popup float-right" onclick="myFunction()" id="addCourse">
         	
         	&nbsp notifications <span class="popuptext" id="myPopup">1</span></button> -->
          ...
          <div class="enrolled-courses">
                	...
                	<div class="d-flex">
                		...
                		<div class="person-info fb70">
                			...
                			<p class="card-text d-flex">
                				<span class="person-exp flex-fill"><i class="fas fa-briefcase"></i> English (CBSC)</span> 
		   ...
		   <div class="btn-sec text-right">
	 			<button class="btn btn-warning findMore">Find More <i class="fas fa-search"></i></button>
	 	  </div>
        </div>
    </div>
</div>
		...
		var obj={};
		 $(document).ready(function(){
			 ...
			 $(".findMore").click(function(){
				 ...
				 window.location=contextPath+"/teacher/otListOfStudents";
